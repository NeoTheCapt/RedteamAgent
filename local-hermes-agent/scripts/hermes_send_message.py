...
Invoked by hermes_compat.sh in response to the legacy
    "$HERMES_BIN" message send --channel <platform> --target <ref> --message <body>
...
def resolve_discord_dm(user_id: str) -> str:
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "hermes-compat (delivery, 1.0)",
        },
