...
LABEL="${LOCAL_HERMES_LAUNCHD_LABEL:-com.neothecapt.redteamopencode.scan-optimizer}"
...
cmd_install() {
  local INTERVAL="${LOCAL_HERMES_INTERVAL_SECONDS:-900}"
  local ENV_FILE="${LOCAL_HERMES_ENV_FILE:-$STATE_DIR/scheduler.env}"
