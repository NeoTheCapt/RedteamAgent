...
assert_contains "$ENGAGE_CMD" 'Before Phase 1 begins, initialize OpenCode'"'"'s native progress UI with `todowrite` following'
assert_contains "$ENGAGE_CMD" 'the operator progress rules in `prompts/agents/operator.txt`'
