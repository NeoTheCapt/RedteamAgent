...
local-openclaw/recall-analysis/<latest>.md and diff solved-challenges
...
Usage:
    python3 recall_regression_report.py \\
        --target <url> \\
        [--out-dir local-openclaw/recall-analysis] \\
        [--history-file local-openclaw/state/benchmark-metrics-history.json]
"""
...
DEFAULT_HISTORY = REPO_ROOT / "local-openclaw" / "state" / "benchmark-metrics-history.json"
DEFAULT_OUT_DIR = REPO_ROOT / "local-openclaw" / "recall-analysis"
