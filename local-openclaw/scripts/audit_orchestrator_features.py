...
Output: local-openclaw/audit-reports/<cycle_id>/features.json
"""
    ...
    findings.append(
        {
            ...
            "summary": summary,
            "evidence": evidence,
            "suggested_fix_path": "local-openclaw/scripts/audit_orchestrator_features.py",
        }
    )
