...
init_eng "$queue_eng"
insert_case "$queue_eng" "GET" "https://www.example.com/en-sg/help" "/en-sg/help" "katana" "done"
...
row = followups[0]
assert row['url'] == 'https://www.example.com/en-sg/account/login-pwd/forget', row
...
init_eng "$cover_eng"
insert_case "$cover_eng" "GET" "https://www.example.com/en-sg/account/login-pwd/forget" "/en-sg/account/login-pwd/forget" "katana" "done"
