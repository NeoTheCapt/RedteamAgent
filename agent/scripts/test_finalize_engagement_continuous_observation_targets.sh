...
make_engagement "$continuous_eng" "https://www.example.com" "www.example.com"
...
env = os.environ.copy()
env["REDTEAM_CONTINUOUS_TARGETS"] = "https://www.example.com"
...
rg -q '\[observation\] Continuous observation hold active for https://www.example.com' "$continuous_out"
