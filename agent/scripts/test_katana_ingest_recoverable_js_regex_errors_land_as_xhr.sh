...
count_xhr="$(sqlite3 "$ENG_DIR/cases.db" "SELECT COUNT(*) FROM cases WHERE url = 'https://www.okx.com/priapi/v1/dx/market/v2/watchlist/token/group/create' AND source = 'katana-xhr';")"
